...
import 'package:chewie/src/player_cached_with_controls.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';
import 'package:wakelock/wakelock.dart';

typedef ChewieCachedRoutePageBuilder = Widget Function(
  BuildContext context,
  Animation<double> animation,
  Animation<double> secondaryAnimation,
  ChewieCachedControllerProvider controllerProvider,
);
...
/// make it easy to use!
class ChewieCached extends StatefulWidget {
  const ChewieCached({
    Key? key,
    required this.controller,
  }) : super(key: key);

  /// The [ChewieCachedController]
  final ChewieCachedController controller;

  @override
  ChewieCachedState createState() {
    return ChewieCachedState();
  }
}

class ChewieCachedState extends State<ChewieCached> {
  ...
  @override
  void didUpdateWidget(ChewieCached oldWidget) {
  ...
  Widget build(BuildContext context) {
    return ChewieCachedControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const PlayerCachedWithControls(),
      ),
    );
  }
  ...
  Widget _fullScreenRoutePageBuilder(
    ...
    final controllerProvider = ChewieCachedControllerProvider(
      controller: widget.controller,
      child: ChangeNotifierProvider<PlayerNotifier>.value(
        value: notifier,
        builder: (context, w) => const PlayerCachedWithControls(),
...
class ChewieCachedController extends ChangeNotifier {
  ChewieCachedController({
  ...
  ChewieCachedController copyWith({
    ...
    Widget Function(
      ...
      Animation<double>,
      Animation<double>,
      ChewieCachedControllerProvider,
    )?
        routePageBuilder,
  }) {
    return ChewieCachedController(
      videoPlayerController:
  ...
  final ChewieCachedRoutePageBuilder? routePageBuilder;
  ...
  static ChewieCachedController of(BuildContext context) {
    final chewieControllerProvider =
        context.dependOnInheritedWidgetOfExactType<ChewieCachedControllerProvider>()!;
...
class ChewieCachedControllerProvider extends InheritedWidget {
  const ChewieCachedControllerProvider({
    Key? key,
    required this.controller,
  ...
  @override
  bool updateShouldNotify(ChewieCachedControllerProvider oldWidget) =>
